# -*- coding: utf-8 -*-
"""
Created on Sat Dec 23 22:10:36 2019
...
def cleanhtml(raw_html):
  ...
  # common patterns
#  cleanr = re.compile('را در .* دنبال کنید')
#  cleantext = re.sub(cleanr, ' ', cleantext) 
#    
#  cleanr = re.compile('لطفا.*از ما حمایت کنید')
#  cleantext = re.sub(cleanr, ' ', cleantext) 
#    
#  cleanr = re.compile('لطفا.*ما ؟را حمایت کنید')
#  cleantext = re.sub(cleanr, ' ', cleantext) 
#    
#    
#  cleanr = re.compile('بسم الله الرحمن الرحیم')
#  cleantext = re.sub(cleanr, ' ', cleantext) 
